      ...
      <PageWrapper className="flex flex-col mt-20">
        ...
        <div className="flex my-44 gap-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p>
              Workplace Insights is designed to ensure the highest level of
              trust and anonymity. Employees can express their opinions without
              fear, and employers can use the feedback to create a better work
              environment.
            </p>
          </div>
        </div>
